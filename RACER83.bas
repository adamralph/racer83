  ...
  130 REPEAT
  140   MT=MT+1:IF (MT) MOD 100=0 AND LV<20 THEN LV=LV+1:SOUND &11,1,LV*5,100
  141   SOUND &10,-11,7,10:RP=INT(RD):*FX 19
  180   COLOUR 2:PRINT TAB(1, 2) BL$:PRINT TAB(1, 31) STRING$(RP+1,RD$)+RG$+STRING$(29-RP,RD$):COLOUR 3:PRINT TAB(OK,9) " ":PRINT TAB(KA,10) KA$
  181   COLOUR 129:PRINT TAB(15,0) " L"+STR$(LV)+": "+STR$(MT)+" m ":COLOUR 128:IF MT MOD (21-LV)=0 THEN COLOUR 1:PRINT TAB(RD+1+RND(8),30) HL$:SOUND &13,3,200,20
