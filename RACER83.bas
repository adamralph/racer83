  ...
  140 COLOUR 3
  150 PRINT TAB(10,24) "Press SPACE to play"
  ...
  460   COLOUR 2:PRINT TAB(1, 31) R$:PRINT TAB(OK,9) BC$:COLOUR 3:PRINT TAB(KA,10) KA$:COLOUR 129:PRINT TAB(15,0) S$:COLOUR 128
  470   IF LV>20 THEN COLOUR 1:PRINT TAB(RD+1+RND(8),30) HL$(RND(8)-1):SOUND &13,3,220,20 ELSE IF MT MOD (21-LV)=0 THEN COLOUR 1:PRINT TAB(RD+1+RND(8),30) HL$((LV-1) MOD 8):SOUND &13,3,200,20
